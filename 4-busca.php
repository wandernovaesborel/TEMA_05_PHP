...
<body>
    <div class="container">
        ...
        <ul>
            <?php foreach ($agenda as $contato): ?>
                <li>
                    ...
                    <strong>Profissão:</strong> <?php echo $contato["profissao"]; ?><br>
                    <strong>Escolaridade:</strong> <?php echo $contato["escolaridade"]; ?><br>
                </li>
            <?php endforeach; ?>
        </ul>
        ...
        <ul>
            <li>Acessando a profissão de João: <?php echo $agenda[0]["profissao"]; ?></li>
